...
//  to use req.body.name(), we introduce 'body-parser' in app.js, the step need not be repeated here.
...
exports.genre_update_get = function(req, res, next) {
    ...
    Genre.findById(req.params.id).exec(function(err, results) {
      ...
      res.render('genre_form', { title: 'Update Genre Name: ' + results.name, genre: results });
    });
...
exports.genre_update_post = [
  ...
  (req, res, next) => {
    ...
    if (!errors.isEmpty()) {
      // There are errors. Render the form again with sanitized values/error messages.
      res.render('genre_form', { title: 'Update Genre Name: ' + req.body.name, genre: genre, errors: errors.array()});
      return;
    }
    else {
      // Data from form is valid.
