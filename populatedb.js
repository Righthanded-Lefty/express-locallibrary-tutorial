...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: populatedb mongodb://cooluser:coolpassword@cluster0.a9azn.mongodb.net/local_library?retryWrites=true');
...
function bookInstanceCreate(book, imprint, backDue, status, cb) {
  bookinstancedetail = { 
    book: book,
    imprint: imprint
  }    
  if (backDue != false) bookinstancedetail.backDue = backDue
